...
# Estos paquetes incluyen herramientas de desarrollo, librerías y paquetes PHP básicos
...
# Estas son las extensiones PHP necesarias para la mayoría de las aplicaciones Laravel
...
# Esto instala y habilita extensiones PHP adicionales, incluyendo pcov para cobertura de código

# Instala Composer (gestor de dependencias de PHP)
RUN curl -sS https://getcomposer.org/installer | php -- --install-dir=/usr/local/bin --filename=composer

# Copia los binarios de Composer y RoadRunner desde sus imágenes oficiales
