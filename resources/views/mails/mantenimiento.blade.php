...
<head>
    ...
    <title>Nuevo Mantenimiento Programado - Espumas Medellín</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; background-color: #f4f4f4; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <div style="background-color: #FF6633; color: #ffffff; padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px;">Nuevo Mantenimiento Programado</h1>
        </div>
        <div style="padding: 20px;">
            <p style="font-size: 16px; color: #555555;">Se ha programado un nuevo mantenimiento con los siguientes detalles:</p>
            ...
            <div style="background-color: #f0f0f0; padding: 15px; border-radius: 4px;">
                <h2 style="color: #FF6633; font-size: 18px; margin-top: 0;">Descripción del mantenimiento&nbsp;</h2>
            ...
            <div style="margin-top: 20px; padding: 15px; background-color: #fff3cd; border-left: 4px solid #FF6633; color: #856404;">
                <p style="margin: 0;">Por favor, tenga en cuenta esta información para planificion de la produccion.</p>
            </div>
            <div style="margin-top: 20px; text-align: center;">
                <p style="font-style: italic; color: #666666;">Si tiene alguna pregunta, no dude en contactar al equipo de mantenimiento.</p>
            </div>
        </div>
        <div style="background-color: #333333; color: #ffffff; padding: 15px; text-align: center; font-size: 14px;">
            ...
            <p style="margin: 5px 0;">Email del creador: {{ $emailCreador }}</p>
        </div>
    </div>
</body>
</html>
